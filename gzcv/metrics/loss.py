...
class L1Loss(AbstractLoss):
    def __init__(self, rel_weight=1, distance_metric="angular_error"):
        super().__init__()
    ...
    def forward(self, data):
        ...
        loss = self.distance_metric(pred_gaze, gt_gaze).mean()
        return loss * self.rel_weight
